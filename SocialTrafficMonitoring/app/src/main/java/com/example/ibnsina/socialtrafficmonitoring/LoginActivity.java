...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private TextView txt_signup_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_signup_button = (TextView)findViewById(R.id.txt_signup_button);
        txt_signup_button.setOnClickListener(new OnClickListener() {
            @Override
...
//            return true;
            ...
            if(mEmail !=null && mPassword !=null) {
                try {
                    arrayPersonal = new JSONArray(Server_data_get.User_Login(mEmail, mPassword));
