...
{
	private static String base_URL = "http://127.0.0.1/";		//Default configuration for WAMP - 80 is default port for WAMP and 10.0.2.2 is localhost IP in Android Emulator
